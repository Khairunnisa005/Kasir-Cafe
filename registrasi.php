            ...
            <div class="col-md-5 mt-5">
                ...
                <div class="p-5">
							<div class="text-center">
								<h4 class="h4 text-gray-900 mb-4">Registrasi Petugas</h1>
                            </div>
                            <form action="" method="POST">
                                <div class="form-group">
                                <input type="text" name="nm_member" class="form-control" placeholder="Nama" required>
                                        </div>
                                <div class="form-group">
                                ...
                                <button type="submit" value="submit" class="btn btn-primary btn-block" name="submit">Registrasi</button>
                                </from>
         <?php
