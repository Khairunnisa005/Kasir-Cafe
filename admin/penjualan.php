...
$query = "SELECT penjualan.*, pelanggan.NamaPelanggan AS NamaPelanggan 
          FROM penjualan 
...
<head>
    ...
    <title>Admin - Tabel - Pelanggan</title>
            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a id="produckButton" class="nav-link active" href="penjualan.php">
                            <div class="sb-nav-link-icon"><i class="fas fa-list"></i></div>
                            Penjualan
                        </a>
                            ...
                            <table id="datatablesSimple" class="table">
                                ...
                                <tbody>
                                    ...
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        ...
                                        echo "<td>" . $row['NamaPelanggan'] . "</td>"; // Menampilkan Nama Pelanggan
                                        echo "<td>";
                                        echo "<a href='edit_user.php?id=" . $row['PenjualanID'] . "' class='btn btn-primary btn-sm'>Edit</a>";
                                        echo "<a href='delete_user.php?id=" . $row['PenjualanID'] . "' class='btn btn-danger btn-sm' onclick='return confirm(\"Apakah Anda yakin ingin menghapus pengguna ini?\")'>Delete</a>";
                                        echo "</td>";
                                        echo "</tr>";
                                    }
                                    ?>
