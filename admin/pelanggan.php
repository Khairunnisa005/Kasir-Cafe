            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a id="pelangganButton" class="nav-link active" href="pelanggan.php">
                            ...
                            <table id="datatablesSimple" class="table">
                                ...
                                <tbody>
                                    ...
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        ...
                                        echo "<td>";
                                        echo "<a href='edit_user.php?id=" . $row['PelangganID'] . "' class='btn btn-primary btn-sm'>Edit</a>";
                                        echo "<a href='deletepelanggan.php?id=" . $row['PelangganID'] . "' class='btn btn-danger btn-sm' onclick='return confirm(\"Apakah Anda yakin ingin menghapus pengguna ini?\")'>Delete</a>";
                                        echo "</td>";
                                        echo "</tr>";
                                    }
                                    ?>
