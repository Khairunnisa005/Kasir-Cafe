...
?>
<!-- Sidebar -->
<ul class="navbar-nav bg-gradient-lebaran sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item active">
        ...
        <div id="collapse3" class="collapse" aria-labelledby="heading3" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="index.php?page=laporan">Detail Penjualan</a>
            </div>
        </div>
    </li>
    <!-- <li class="nav-item active">
