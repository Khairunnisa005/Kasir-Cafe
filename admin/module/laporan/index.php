			...
			<div class="card-body p-0">
				<form method="post" action="index.php?page=laporan&cari=ok">
					<table class="table  table-striped">
                        ...
                        <tr style="background:#C5EBAA;color:#333;">
							<th>
								Pilih Bulan
							</th>
							<th>
				...
				<form method="post" action="index.php?page=laporan&hari=cek">
					<table class="table table-striped">
					<tr style="background:#F9E897;color:#333;">
							<th>
								Pilih Hari
							</th>
							<th>
					...
					<table class="table table-bordered w-60 table-sm" id="example1">
						...
						<tbody>
							...
							<?php 
							        ...
							        // $sql1 = "UPDATE nota SET PelangganID='$pelangganId'";
								$bayar = 0;
								$jumlah = 0;
								$modal = 0;
