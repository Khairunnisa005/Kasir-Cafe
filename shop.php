...
*/ -->
<?php
include "koneksi.php"; // Ensure this file includes your database connection
				...
				?>
					...
					<div class="col-12 col-md-4 col-lg-3 mb-5">
						<div class="product-item">
							<img src="images/<?php echo $row['GambarProduk']; ?>" class="img-fluid product-thumbnail">
							<h3 class="product-title"><?php echo $row['NamaProduk']; ?></h3>
							<strong class="product-price"><?php echo format_rupiah($row['Harga']); ?></strong>
							<button class="btn btn-primary add-to-cart-btn" data-product-id="<?php echo $row['ProdukID']; ?>">Tambah ke Keranjang</button>
						</div>
					</div>
					<!-- End Column -->
